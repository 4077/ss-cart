<table style="border-collapse: separate; border-spacing: 1px; background-color: #C5C5C5;">
    ...
    <!-- / -->
    <tr>
        <td style="padding: 3px 5px; background-color: #FFFFFF; text-align: right; font-weight: bold;" colspan="3">{TOTAL_COST_LABEL}</td>
        <td style="padding: 3px 5px; background-color: #FFFFFF;">{TOTAL_COST}</td>
    </tr>
    <!-- global_discount -->
    <tr>
        <td style="padding: 3px 5px; background-color: #FFFFFF; text-align: right; font-weight: bold;" colspan="3">{TOTAL_COST_LABEL}</td>
